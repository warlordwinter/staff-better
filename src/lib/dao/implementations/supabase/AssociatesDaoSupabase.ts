...
import { IAssociatesDao } from "../../interfaces/IAssociatesDao";

export class AssociateDaoSupabase implements IAssociatesDao {
  ...
  async deleteAssociate(id: string): Promise<{ success: boolean }> {
    const supabase = await createServerSupabaseClient();
