...
const FUNCTION_NAME = 'DailySummaryEmail';
...
return new Promise((resolve, reject) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        try {
          ...
          console.log('\n💡 Next steps:');
          console.log('   1. Check CloudWatch Logs: /aws/lambda/DailySummaryEmail');
          console.log('   2. Test the function using AWS Console or CLI');
          console.log('\n✨ Done!');
          resolve();
        } catch (error) {
  ...
  archive.file(path.join(lambdaDir, 'emailTemplate.js'), { name: 'emailTemplate.js' });
